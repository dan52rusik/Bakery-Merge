...
#else
#if RU_YG2
            YG2.Message("OnURL_Yandex_DefineDomain: Модуль EnvirData не установлен, домен не определен!");
#else
            YG2.Message("OnURL_Yandex_DefineDomain: EnvirData module not installed, domain not defined!");
#endif
#endif
        }
    }
